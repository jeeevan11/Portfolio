...
export const skillGroups = [
  { key: 'lang',     label: 'Languages',        image: '/logos/python.svg',   items: ['Python', 'TypeScript', 'JavaScript', 'C++', 'Java', 'Swift', 'Kotlin', 'SQL'] },
  { key: 'frontend', label: 'Frontend & apps',  image: '/logos/react.svg',    items: ['React', 'Next.js', 'Vite', 'Tailwind', 'SwiftUI', 'Jetpack Compose'] },
  { key: 'backend',  label: 'Backend & data',   image: '/logos/postgres.svg', items: ['FastAPI', 'Node', 'Deno', 'WebSockets', 'WebRTC', 'Postgres', 'pgvector', 'Supabase', 'SQLite', 'Stripe'] },
  ...
  { key: 'infra',    label: 'Infra & tooling',  image: '/logos/vercel.svg',   items: ['Docker', 'Vercel', 'Railway', 'Hugging Face', 'CI', 'mitmproxy', 'Git'] },
]
...
export const recognition = [
  ...
  { key: 'iqoo', title: 'iQOO Hackathon, Bengaluru', detail: 'Special Honour and prize money' },
]
